...
if __name__ == '__main__':
    ...
    L_SEPSO = SEPSO_Down(dvc=dvc, Random_Obs = opt.RO, DPI=opt.DPI, Kinematics_Penalty=opt.KP)
    ...
    for seed in range(100):
        current_score, TPP = L_SEPSO.Dynamicly_Plan_And_Track(params, seed=seed)  # 这里current_score实际上是路径长度(未到达时为0)
